    ...
    <footer className="border-t border-border bg-card">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold">Ingenium</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm text-muted-foreground" dir="ltr">+963 987 562 678</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-muted-foreground">info@ingenium.sy</span>
              </li>
            </ul>
          </div>
          ...
          {/* Working Hours */}
          <div>
            <h3 className="mb-4 text-lg font-semibold">{t.contact.info.hours}</h3>
        ...
        <div className="mt-12 border-t border-border pt-6 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Ingenium. {t.footer.rights}.
          </p>
        </div>
      </div>
    </footer>
